...
export default function Admin() {
    ...
    useEffect(() => {
        async function getProjet() {
          try {
            const response = await fetch('api/admin/getProjetNoValidate');
            if (response.ok) {
      ...
      function handleValidation(idProjet, isChecked) {
        ...
        fetch(`api/admin/project/${idProjet}`, {
      ...
      function handleDelete(idProjet) {
        ...
        fetch(`api/admin/deleteProject/${idProjet}`, {
      ...
      async function handleDescriptionUpdate(idProjet) {
        ...
        try {
          ...
          const response = await fetch(`api/admin/updateProjectDescription/${idProjet}`, {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json',
            },
